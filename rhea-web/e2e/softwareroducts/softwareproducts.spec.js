    ...
    describe('The Software Products view', function() {
        var page;

        beforeEach(function() {
            browser.get('/#/softwareproducts');
        ...
        it('should display page', function() {
            ...
            expect(page.pageHeader.getText()).toContain('Software Products');

            expect(page.panel.isDisplayed()).toBe(true);
            expect(page.panelHeader.isDisplayed()).toBe(true);
            expect(page.panelHeader.getText()).toContain('Software Products');
        });
        ...
        it('should display Add modal', function() {
            ...
            browser.waitForAngular();
            expect(page.activeModalHeader.isDisplayed()).toBe(true);
            expect(page.activeModalHeader.getText()).toEqual('Add Software Product');
        });
