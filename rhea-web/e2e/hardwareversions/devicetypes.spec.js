    ...
    describe('The Hardware Versions view', function() {
        var page;

        beforeEach(function() {
            browser.get('/#/devicetypes');
        ...
        it('should display page', function() {
            ...
            expect(page.pageHeader.getText()).toContain('Hardware Versions');

            expect(page.panel.isDisplayed()).toBe(true);
            expect(page.panelHeader.isDisplayed()).toBe(true);
            expect(page.panelHeader.getText()).toContain('Hardware Versions');
        });
        ...
        it('should display Add modal', function() {
            ...
            browser.waitForAngular();
            expect(page.activeModalHeader.isDisplayed()).toBe(true);
            expect(page.activeModalHeader.getText()).toEqual('Add Hardware Version');
        });
