...
@RestController
@RequestMapping("/api/rhea/security")
public class RheaSecurityApi extends BaseApiAbstract {
	...
	public UserModel user() {
		Product product = getCoreCacheService().findProductBySystemName(ProductSystemNames.RHEA);
