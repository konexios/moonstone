...
public class DatabusFactory {
	private final static String REDIS_DATABUS_CLASS = "com.arrow.selene.databus.RedisDatabus";
	private final static String RABBITMQ_DATABUS_CLASS = "com.arrow.selene.databus.RabbitmqDatabus";
	private final static String FILE_DATABUS_CLASS = "com.arrow.selene.databus.FileDatabus";
	private final static String MQTT_DATABUS_CLASS = "com.arrow.selene.databus.MqttDatabus";
