...
public class SelectionMask1 implements ConfigParameter<SelectionMask1> {
	private static final long serialVersionUID = -2392333040823564554L;
	...
	public SelectionMask1(int maskLength, Mode mode, int startPointer, byte[] mask) {
	...
	@Override
	public SelectionMask1 parse(byte... payload) {
		...
		buffer.get(mask);
		return new SelectionMask1(maskLength, mode, startPointer, mask);
	}
	...
	public boolean equals(Object o) {
		...
		SelectionMask1 that = (SelectionMask1) o;
