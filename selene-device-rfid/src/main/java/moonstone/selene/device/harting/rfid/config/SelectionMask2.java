...
public class SelectionMask2 implements ConfigParameter<SelectionMask2> {
	private static final long serialVersionUID = -2872235064075550396L;
	...
	public SelectionMask2(int maskLength, Mode mode, int startPointer, byte[] mask) {
	...
	@Override
	public SelectionMask2 parse(byte... payload) {
		...
		buffer.get(mask);
		return new SelectionMask2(maskLength, mode, startPointer, mask);
	}
	...
	public boolean equals(Object o) {
		...
		SelectionMask2 that = (SelectionMask2) o;
