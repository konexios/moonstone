...
import moonstone.selene.device.harting.rfid.command.BaudRateDetection;
import moonstone.selene.device.harting.rfid.command.ClearDataBuffer;
import moonstone.selene.device.harting.rfid.command.Command;
import moonstone.selene.device.harting.rfid.command.EmptyResponse;
import moonstone.selene.device.harting.rfid.command.ForceNotifyTrigger;
import moonstone.selene.device.harting.rfid.command.GetInput;
import moonstone.selene.device.harting.rfid.command.GetInputResponse;
import moonstone.selene.device.harting.rfid.command.GetReaderInfo;
import moonstone.selene.device.harting.rfid.command.GetReaderInfoResponse;
import moonstone.selene.device.harting.rfid.command.GetSoftwareVersion;
import moonstone.selene.device.harting.rfid.command.GetSoftwareVersionResponse;
import moonstone.selene.device.harting.rfid.command.GetSystemTimeAndDate;
import moonstone.selene.device.harting.rfid.command.GetSystemTimeAndDateResponse;
import moonstone.selene.device.harting.rfid.command.GetSystemTimer;
import moonstone.selene.device.harting.rfid.command.GetSystemTimerResponse;
import moonstone.selene.device.harting.rfid.command.InitializeBuffer;
import moonstone.selene.device.harting.rfid.command.Inventory;
import moonstone.selene.device.harting.rfid.command.InventoryResponse;
import moonstone.selene.device.harting.rfid.command.LockRegion;
import moonstone.selene.device.harting.rfid.command.ReadBuffer;
import moonstone.selene.device.harting.rfid.command.ReadBufferResponse;
import moonstone.selene.device.harting.rfid.command.ReadConfiguration;
import moonstone.selene.device.harting.rfid.command.ReadConfigurationResponse;
import moonstone.selene.device.harting.rfid.command.ReadDataBufferInfo;
import moonstone.selene.device.harting.rfid.command.ReadDataBufferInfoResponse;
import moonstone.selene.device.harting.rfid.command.ReadMultipleBlocks;
import moonstone.selene.device.harting.rfid.command.ReadMultipleBlocksResponse;
import moonstone.selene.device.harting.rfid.command.ReaderDiagnostic;
import moonstone.selene.device.harting.rfid.command.ReaderDiagnosticResponse;
import moonstone.selene.device.harting.rfid.command.ReaderLogin;
import moonstone.selene.device.harting.rfid.command.ResetConfiguration;
import moonstone.selene.device.harting.rfid.command.Response;
import moonstone.selene.device.harting.rfid.command.RfControllerReset;
import moonstone.selene.device.harting.rfid.command.RfOutputOnOff;
import moonstone.selene.device.harting.rfid.command.RfReset;
import moonstone.selene.device.harting.rfid.command.SetOutput;
import moonstone.selene.device.harting.rfid.command.SetSystemTimeAndDate;
import moonstone.selene.device.harting.rfid.command.SetSystemTimer;
import moonstone.selene.device.harting.rfid.command.SystemReset;
import moonstone.selene.device.harting.rfid.command.WriteConfiguration;
import moonstone.selene.device.harting.rfid.command.WriteMultipleBlocks;
import moonstone.selene.device.harting.rfid.command.WriteMultipleBlocksResponse;
import moonstone.selene.device.harting.rfid.command.ReadBufferResponse.Dataset;
import moonstone.selene.device.harting.rfid.command.ReadConfiguration.CfgAddress;
import moonstone.selene.device.harting.rfid.command.ReadConfiguration.Location;
import moonstone.selene.device.harting.rfid.command.ReaderDiagnostic.Mode;
import moonstone.selene.device.harting.rfid.command.SetSystemTimeAndDate.Date;
import moonstone.selene.device.harting.rfid.command.SetSystemTimeAndDate.Time;
...
import moonstone.selene.device.harting.rfid.config.InterfaceAndMode.ReaderMode;
import moonstone.selene.device.harting.rfid.mqtt.MqttResponse;
import moonstone.selene.device.harting.rfid.tag.GenericTagData;
import moonstone.selene.device.harting.rfid.tag.GenericTagModule;
import moonstone.selene.device.harting.rfid.tag.TagModuleAbstract;
...
public class RfidReaderModule
    ...
    private void processTelemetry(byte[] bytes) {
        ...
        queueDataForSending(new IncomingTelemetryData(
                JsonUtils.fromJsonBytes(bytes, moonstone.selene.device.harting.rfid.Utils.getMapTypeRef())));
    }
    ...
    private void processCommand(byte[] bytes) {
        ...
        Map<String, String> data = JsonUtils.fromJsonBytes(bytes,
                moonstone.selene.device.harting.rfid.Utils.getMapTypeRef());
