...
import com.arrow.selene.device.harting.rfid.command.Inventory.AntennaSelector;
import com.arrow.selene.device.harting.rfid.command.ReadBufferResponse.Dataset.AntennaExtended;
