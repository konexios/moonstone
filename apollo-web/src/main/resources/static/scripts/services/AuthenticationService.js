services.factory('AuthenticationService',
    ...
    function ($http, $q, $rootScope, $uibModal, SecurityService, SpinnerService) {
        ...
        function user() {
            return $http.get('/api/apollo/security/user', {});
        }
        ...
        function signInUserAuthType(userName) {
            return $http.get('/api/apollo/security/getUserAuthenticationType/' + userName, {});
        }
//        
//        function signInUserForgot(userName) {
//        		return $http.get('/api/apollo/users/password/forgot' + userName, {});
//		}
            ...
            if (user && user.login) {
                if (user.applications.length >= 1) {
                    ...
                    if (user.applications.length > 1) {
                        ...
                        if (!promise) {
                        	var appNotSelected = "You must select the application.";
        ...
        return {
            ...
            signInUserAuthType: signInUserAuthType
        };
    }
]);
