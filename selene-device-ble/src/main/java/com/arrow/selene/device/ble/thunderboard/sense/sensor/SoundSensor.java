...
public class SoundSensor extends BleSensorAbstract<HumiditySensorProperties, FloatSensorData> {
	private static final String SOUND = "sound";
	private static final float SCALE = 100.0f;
	private static final String[] UUIDs = { GattConstants.UUID_SOUND_LEVEL_SENSOR };
	...
	public List<FloatSensorData> parseData(byte[] data) {
		...
		return Collections.singletonList(new FloatSensorData(SOUND, value, EngineConstants.FORMAT_DECIMAL_2));
	}
	...
	public byte[] readValue() {
		return getBluetoothGatt().readValue(GattConstants.UUID_SOUND_LEVEL_SENSOR);
	}
