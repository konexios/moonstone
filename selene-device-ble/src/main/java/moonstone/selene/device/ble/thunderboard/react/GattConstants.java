...
public class GattConstants {
	...
	public static final String UUID_LIGHT_SENSOR = "c8546913-bfd9-45eb-8dde-9f8754f4a32e";
	...
	public static final String UUID_KEYS_SENSOR = "00002a56-0000-1000-8000-00805f9b34fb";

	public static final String UUID_LEDS_CONTROL = "00002a56-0000-1000-8000-00805f9b34fb";
