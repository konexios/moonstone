...
public class HcidumpAdvertisingReader extends AdvertisingReader {
    ...
    @Override
    public void cleanup() {
        moonstone.acn.client.utils.Utils.shutdownProcess(hcitoolProcess, "hcitoolProcess");
        moonstone.acn.client.utils.Utils.shutdownProcess(hcidumpProcess, "hcidumpProcess");
        moonstone.acn.client.utils.Utils.shutdownThread(parserThread);
    }
