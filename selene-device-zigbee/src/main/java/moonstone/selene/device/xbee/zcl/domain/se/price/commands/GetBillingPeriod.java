...
public class GetBillingPeriod extends ClusterSpecificCommand<GetBillingPeriod> {
	...
	public GetBillingPeriod withEarliestStartTime(long earliestStartTime) {
	...
	public GetBillingPeriod withMinIssuerEventId(long minIssuerEventId) {
	...
	public GetBillingPeriod withNumberOfCommands(int numberOfCommands) {
	...
	public GetBillingPeriod withTariffType(TariffType tariffType) {
	...
	@Override
	protected int getId() {
		return PriceClusterCommands.GET_BILLING_PERIOD_COMMAND_ID;
	}
	...
	@Override
	public GetBillingPeriod fromPayload(byte[] payload) {
