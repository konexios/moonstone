...
public class EnhancedAddScene extends ClusterSpecificCommand<EnhancedAddScene> {
	private int groupId;
	private int sceneId;
	...
	public EnhancedAddScene withGroupId(int groupId) {
	...
	public EnhancedAddScene withSceneId(int sceneId) {
	...
	public EnhancedAddScene withTransactionTime(int transactionTime) {
	...
	public EnhancedAddScene withSceneName(String sceneName) {
	...
	public EnhancedAddScene withExtensionFields(Set<ExtensionField> extensionFields) {
	...
	@Override
	protected int getId() {
		return ScenesClusterCommands.ENHANCED_ADD_SCENE_COMMAND_ID;
	}
	...
	@Override
	public EnhancedAddScene fromPayload(byte[] payload) {
