...
import moonstone.selene.device.xbee.zcl.domain.ha.events.data.AlertStructure;
import moonstone.selene.device.xbee.zcl.domain.ha.events.data.AlertType;
import moonstone.selene.device.xbee.zcl.domain.ha.events.data.Category;
import moonstone.selene.device.xbee.zcl.domain.ha.events.data.PresenceRecovery;

public class AlertsNotification extends ClusterSpecificCommand<AlertsNotification> {
	...
	public AlertsNotification withNumberOfAlerts(byte numberOfAlerts) {
	...
	public AlertsNotification withAlertType(AlertType alertType) {
	...
	public AlertsNotification withAlertStructures(AlertStructure[] alertStructures) {
	...
	@Override
	protected int getId() {
		return ApplianceEventsAndAlertClusterCommands.ALERTS_NOTIFICATION_COMMAND_ID;
	}
	...
	@Override
	public AlertsNotification fromPayload(byte[] payload) {
