...
public class MainsVoltageMaxThreshold implements Attribute<DoubleSensorData> {
	...
	@Override
	public int getId() {
		return PowerConfigClusterAttributes.MAINS_VOLTAGE_MAX_THRESHOLD_ATTRIBUTE_ID;
	}
