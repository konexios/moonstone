...
import moonstone.selene.device.xbee.zcl.domain.general.scenes.data.ExtensionField;

public class EnhancedViewSceneResponse extends ClusterSpecificCommand<EnhancedViewSceneResponse> {
	private int status;
	private int groupId;
	private int sceneId;
	...
	public EnhancedViewSceneResponse withStatus(int status) {
		this.status = status;
		return this;
	}
	...
	public EnhancedViewSceneResponse withGroupId(int groupId) {
	...
	public EnhancedViewSceneResponse withSceneId(int sceneId) {
	...
	public EnhancedViewSceneResponse withTransactionTime(int transactionTime) {
	...
	public EnhancedViewSceneResponse withSceneName(String sceneName) {
	...
	public EnhancedViewSceneResponse withExtensionFields(Set<ExtensionField> extensionFields) {
	...
	@Override
	protected int getId() {
		return ScenesClusterCommands.ENHANCED_VIEW_SCENE_RESPONSE_COMMAND_ID;
	}
	...
	@Override
	public EnhancedViewSceneResponse fromPayload(byte[] payload) {
