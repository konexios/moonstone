...
public class EnergyPhasesScheduleResponse extends ClusterSpecificCommand<EnergyPhasesScheduleResponse> {
	...
	public EnergyPhasesScheduleResponse withPowerProfileId(int powerProfileId) {
	...
	public EnergyPhasesScheduleResponse withScheduledPhases(ScheduledPhase[] scheduledPhases) {
	...
	@Override
	protected int getId() {
		return PowerProfileClusterCommands.ENERGY_PHASES_SCHEDULE_RESPONSE_COMMAND_ID;
	}
	...
	@Override
	public EnergyPhasesScheduleResponse fromPayload(byte[] payload) {
