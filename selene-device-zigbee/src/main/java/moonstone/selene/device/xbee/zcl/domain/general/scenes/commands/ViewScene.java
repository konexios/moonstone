...
public class ViewScene extends ClusterSpecificCommand<ViewScene> {
	private int groupId;
	private int sceneId;
	...
	public ViewScene withGroupId(int groupId) {
	...
	public ViewScene withSceneId(int sceneId) {
	...
	@Override
	protected int getId() {
		return ScenesClusterCommands.VIEW_SCENE_COMMAND_ID;
	}
	...
	@Override
	public ViewScene fromPayload(byte[] payload) {
