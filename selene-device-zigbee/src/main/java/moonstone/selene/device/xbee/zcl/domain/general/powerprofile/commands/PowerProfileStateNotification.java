...
import moonstone.selene.device.xbee.zcl.domain.general.powerprofile.data.PowerProfile;
import moonstone.selene.device.xbee.zcl.domain.general.powerprofile.data.PowerProfileState;

public class PowerProfileStateNotification extends ClusterSpecificCommand<PowerProfileStateNotification> {
	...
	public PowerProfileStateNotification withPowerProfiles(PowerProfile[] powerProfiles) {
	...
	@Override
	protected int getId() {
		return PowerProfileClusterCommands.POWER_PROFILES_STATE_NOTIFICATION_COMMAND_ID;
	}
	...
	@Override
	public PowerProfileStateNotification fromPayload(byte[] payload) {
