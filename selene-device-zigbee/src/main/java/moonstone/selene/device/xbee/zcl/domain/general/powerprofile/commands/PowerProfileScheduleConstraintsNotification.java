...
public class PowerProfileScheduleConstraintsNotification extends ClusterSpecificCommand<PowerProfileScheduleConstraintsNotification> {
	...
	public PowerProfileScheduleConstraintsNotification withPowerProfileId(int powerProfileId) {
	...
	public PowerProfileScheduleConstraintsNotification withStartAfter(int startAfter) {
	...
	public PowerProfileScheduleConstraintsNotification withStartBefore(int startBefore) {
	...
	@Override
	protected int getId() {
		return PowerProfileClusterCommands.POWER_PROFILE_SCHEDULE_CONSTRAINTS_NOTIFICATION_COMMAND_ID;
	}
	...
	@Override
	public PowerProfileScheduleConstraintsNotification fromPayload(byte[] payload) {
