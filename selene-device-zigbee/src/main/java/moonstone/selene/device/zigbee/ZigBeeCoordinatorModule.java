...
import moonstone.selene.device.xbee.zdo.NodeDescriptorRequest;
...
import moonstone.selene.device.zigbee.handlers.commands.CommandHandler;
import moonstone.selene.device.zigbee.handlers.commands.PermitJoinCommandHandler;
import moonstone.selene.device.zigbee.handlers.commands.StartDiscoveryCommandHandler;
import moonstone.selene.device.zigbee.handlers.commands.StopDiscoveryCommandHandler;
import moonstone.selene.device.zigbee.handlers.messages.ActiveEndpointsResponseHandler;
import moonstone.selene.device.zigbee.handlers.messages.BindResponseHandler;
import moonstone.selene.device.zigbee.handlers.messages.ConfigureReportingResponseHandler;
import moonstone.selene.device.zigbee.handlers.messages.DefaultResponseHandler;
import moonstone.selene.device.zigbee.handlers.messages.DeviceAnnounceHandler;
import moonstone.selene.device.zigbee.handlers.messages.DiscoverAttributesExtendedHandler;
import moonstone.selene.device.zigbee.handlers.messages.DiscoverCommandsGeneratedHandler;
import moonstone.selene.device.zigbee.handlers.messages.DiscoverCommandsReceivedHandler;
import moonstone.selene.device.zigbee.handlers.messages.ManagementLqiResponseHandler;
import moonstone.selene.device.zigbee.handlers.messages.MatchDescriptorRequestHandler;
import moonstone.selene.device.zigbee.handlers.messages.MessageHandler;
import moonstone.selene.device.zigbee.handlers.messages.NetworkAddressResponseHandler;
import moonstone.selene.device.zigbee.handlers.messages.NodeDescriptorResponseHandler;
import moonstone.selene.device.zigbee.handlers.messages.ReadAttributesResponseHandler;
import moonstone.selene.device.zigbee.handlers.messages.ReportAttributesHandler;
import moonstone.selene.device.zigbee.handlers.messages.SimpleDescriptorResponseHandler;
import moonstone.selene.device.zigbee.handlers.messages.UnbindResponseHandler;
import moonstone.selene.device.zigbee.handlers.messages.ZoneEnrollRequestHandler;
...
public class ZigBeeCoordinatorModule extends
	...
	private static Map<String, Properties> loadPropsFromDB() {
		return DeviceService.getInstance().find(ZigBeeEndDeviceInfo.DEFAULT_DEVICE_TYPE).stream()
				.filter(device -> device.getHid() != null).map(moonstone.selene.engine.Utils::getProperties)
