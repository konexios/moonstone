...
public interface AnalogInputRegularAttributes {
    short COV_INCREMENT_ATTRIBUTE_ID = 0x0016;
    ...
    short UPDATE_INTERVAL_ATTRIBUTE_ID = 0x0076;
    short PROFILE_NAM_ATTRIBUTE_ID = 0x00a8;
}
