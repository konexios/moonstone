...
import com.arrow.selene.device.xbee.zcl.domain.general.powerprofile.data.EnergyPhase;

public class PowerProfileResponse extends ClusterSpecificCommand<PowerProfileResponse> {
	...
	public PowerProfileResponse withTotalProfileNum(int totalProfileNum) {
	...
	public PowerProfileResponse withPowerProfileId(int powerProfileId) {
	...
	public PowerProfileResponse withEnergyPhases(EnergyPhase[] energyPhases) {
	...
	@Override
	protected int getId() {
		return PowerProfileClusterCommands.POWER_PROFILE_RESPONSE_COMMAND_ID;
	}
	...
	@Override
	public PowerProfileResponse fromPayload(byte[] payload) {
