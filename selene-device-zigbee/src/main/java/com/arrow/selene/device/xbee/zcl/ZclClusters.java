...
import com.arrow.selene.device.xbee.zcl.domain.closures.door.attributes.DoorLockClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.closures.door.commands.DoorLockClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.closures.shade.attributes.ShadeClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.closures.shade.commands.ShadeClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.closures.window.attributes.WindowCoveringClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.closures.window.commands.WindowCoveringClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.alarms.attributes.AlarmClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.alarms.commands.AlarmsClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.appliance.attributes.ApplianceControlClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.appliance.commands.ApplianceControlClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.attributes.BasicAnalogInputClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.attributes.BasicAnalogOutputClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.attributes.BasicAnalogValueClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.attributes.BasicBinaryInputClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.attributes.BasicBinaryOutputClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.attributes.BasicBinaryValueClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.attributes.BasicClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.attributes.BasicMultistateInputClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.attributes.BasicMultistateOutputClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.attributes.BasicMultistateValueClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.commands.BasicAnalogInputClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.commands.BasicAnalogOutputClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.commands.BasicAnalogValueClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.commands.BasicBinaryInputClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.commands.BasicBinaryOutputClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.commands.BasicBinaryValueClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.commands.BasicClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.commands.BasicMultistateInputClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.commands.BasicMultistateOutputClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.basic.commands.BasicMultistateValueClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.commissioning.attributes.CommissioningClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.commissioning.commands.CommissioningClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.groups.attributes.GroupsClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.groups.commands.GroupsClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.identify.attributes.IdentifyClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.identify.commands.IdentifyClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.levelcontrol.attributes.LevelControlClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.levelcontrol.commands.LevelControlClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.onoff.attributes.OnOffClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.onoff.commands.OnOffClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.otabootload.attributes.OtaBootloadClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.otabootload.commands.OtaBootloadClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.partition.attributes.PartitionClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.partition.commands.PartitionClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.pollcontrol.attributes.PollControlClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.pollcontrol.commands.PollControlClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.power.attributes.PowerConfigClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.power.commands.PowerClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.powerprofile.attributes.PowerProfileClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.powerprofile.commands.PowerProfileClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.rssilocation.attributes.RssiLocationClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.rssilocation.commands.RssiLocationClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.scenes.attributes.ScenesClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.scenes.commands.ScenesClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.switchconfig.attributes.SwitchConfigClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.switchconfig.commands.SwitchConfigClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.temperature.attributes.TemperatureClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.temperature.commands.TemperatureClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.general.time.attributes.TimeClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.general.time.commands.TimeClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.ha.diagnostics.attributes.DiagnosticsClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.ha.diagnostics.commands.DiagnosticsClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.ha.events.attributes.ApplianceEventsAndAlertClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.ha.events.commands.ApplianceEventsAndAlertClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.ha.identification.attributes.ApplianceIdentificationClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.ha.identification.attributes.MeterIdentificationClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.ha.identification.commands.ApplianceIdentificationClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.ha.identification.commands.MeterIdentificationClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.ha.measurement.attributes.ElectricalMeasurementClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.ha.measurement.commands.ElectricalMeasurementClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.ha.statistics.attributes.ApplianceStatisticsClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.ha.statistics.commands.ApplianceStatisticsClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.hvac.dehumidification.attributes.DehumidificationClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.hvac.dehumidification.commands.DehumidificationClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.hvac.fan.attributes.HvacFanClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.hvac.fan.commands.HvacFanClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.hvac.pump.attributes.HvacPumpClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.hvac.pump.commands.HvacPumpClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.hvac.thermostat.attributes.HvacThermostatClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.hvac.thermostat.commands.HvacThermostatClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.hvac.ui.attributes.HvacUiClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.hvac.ui.commands.HvacUiClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.lighting.ballast.attributes.LightingBallastClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.lighting.ballast.commands.LightingBallastClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.lighting.color.attributes.LightingColorClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.lighting.color.commands.LightingColorClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.measurement.flow.attributes.FlowMeasurementClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.measurement.flow.commands.FlowMeasurementClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.measurement.humidity.attributes.HumidityMeasurementClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.measurement.humidity.commands.HumidityMeasurementClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.measurement.illuminance.attributes
		.IlluminanceMeasurementClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.measurement.illuminance.commands.IlluminanceMeasurementClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.measurement.levelsensing.attributes
		.LevelSensingMeasurementClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.measurement.levelsensing.commands.LevelSensingMeasurementClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.measurement.occupancy.attributes.OccupancyMeasurementClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.measurement.occupancy.commands.OccupancyMeasurementClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.measurement.pressure.attributes.PressureMeasurementClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.measurement.pressure.commands.PressureMeasurementClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.measurement.temperature.attributes
		.TemperatureMeasurementClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.measurement.temperature.commands.TemperatureMeasurementClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.protocol.bacnet.commands.BacnetProtocolTunnelClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.protocol.generic.attributes.GenericTunnelClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.protocol.generic.commands.GenericTunnelClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.protocol.iso11073.attributes.Iso11073ProtocolTunnelClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.protocol.iso11073.commands.Iso11073ProtocolTunnelClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.protocol.iso7816.attributes.Iso7816ProtocolTunnelClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.protocol.iso7816.commands.Iso7816ProtocolTunnelClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.se.demand.attributes.DemandResponseAndLoadControlClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.se.demand.commands.DemandResponseAndLoadControlClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.se.metering.attributes.SimpleMeteringClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.se.metering.commands.SimpleMeteringClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.se.price.attributes.PriceClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.se.price.commands.PriceClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.security.ace.attributes.SecurityAceClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.security.ace.commands.SecurityAceClusterCommands;
import com.arrow.selene.device.xbee.zcl.domain.security.wd.attributes.SecurityWdClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.security.wd.commands.SecurityWdClusterCommands;
...
import com.arrow.selene.device.xbee.zcl.domain.zll.commissioning.attributes.ZllCommissioningClusterAttributes;
import com.arrow.selene.device.xbee.zcl.domain.zll.commissioning.commands.ZllCommissioningClusterCommands;
