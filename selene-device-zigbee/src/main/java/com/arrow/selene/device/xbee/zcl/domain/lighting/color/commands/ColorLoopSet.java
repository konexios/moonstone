...
import com.arrow.selene.device.xbee.zcl.domain.lighting.color.data.Action;
import com.arrow.selene.device.xbee.zcl.domain.lighting.color.data.LoopDirection;
import com.arrow.selene.device.xbee.zcl.domain.lighting.color.data.UpdateFlags;
