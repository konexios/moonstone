...
public class DiscoverAttributesExtendedRequest extends GeneralRequest {
	int startAttributeId;
	int maxAttributeIds;

	public DiscoverAttributesExtendedRequest(int manufacturerCode, int startAttributeId, int maxAttributeIds) {
	...
	@Override
	protected int getId() {
		return HaProfileCommands.DISCOVER_ATTRIBUTES_EXTENDED;
	}
}
