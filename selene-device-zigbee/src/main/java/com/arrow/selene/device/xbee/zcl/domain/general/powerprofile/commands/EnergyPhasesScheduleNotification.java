...
public class EnergyPhasesScheduleNotification extends ClusterSpecificCommand<EnergyPhasesScheduleNotification> {
	...
	public EnergyPhasesScheduleNotification withPowerProfileId(int powerProfileId) {
	...
	public EnergyPhasesScheduleNotification withScheduledPhases(ScheduledPhase[] scheduledPhases) {
	...
	@Override
	protected int getId() {
		return PowerProfileClusterCommands.ENERGY_PHASES_SCHEDULE_NOTIFICATION_COMMAND_ID;
	}
	...
	@Override
	public EnergyPhasesScheduleNotification fromPayload(byte[] payload) {
