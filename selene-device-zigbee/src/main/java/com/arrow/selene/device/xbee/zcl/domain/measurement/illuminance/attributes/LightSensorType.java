package com.arrow.selene.device.xbee.zcl.domain.measurement.illuminance.attributes;
...
public enum LightSensorType implements Attribute<StringSensorData> {
	...
	@Override
	public int getId() {
		return IlluminanceMeasurementClusterAttributes.LIGHT_SENSOR_TYPE_ATTRIBUTE_ID;
	}
