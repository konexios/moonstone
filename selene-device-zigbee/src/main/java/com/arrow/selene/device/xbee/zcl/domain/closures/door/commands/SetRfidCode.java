...
public class SetRfidCode extends ClusterSpecificCommand<SetRfidCode> {
	private int userId;
	...
	public SetRfidCode withUserId(int userId) {
		this.userId = userId;
		return this;
	}
	...
	public SetRfidCode withUserStatus(UserStatus userStatus) {
	...
	public SetRfidCode withUserType(UserType userType) {
	...
	public SetRfidCode withCode(byte[] code) {
		this.code = code;
		return this;
	}
	...
	@Override
	protected int getId() {
		return DoorLockClusterCommands.SET_RFID_COMMAND_ID;
	}
	...
	@Override
	protected SetRfidCode fromPayload(byte[] payload) {
