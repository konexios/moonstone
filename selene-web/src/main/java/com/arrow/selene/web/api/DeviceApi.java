...
import com.arrow.selene.web.api.data.BleDiscoveryModel;
import com.arrow.selene.web.api.data.OsModel;
import com.arrow.selene.web.api.model.DeviceModels;
import com.arrow.selene.web.api.model.DeviceModels.DeviceList;
	...
	public class DeviceListener extends DatabusListenerAbstract {
		...
		public void receive(String queue, byte[] message) {
			...
			try {
				...
				com.arrow.selene.model.StatusModel model = JsonUtils.fromJsonBytes(message,
						com.arrow.selene.model.StatusModel.class);
