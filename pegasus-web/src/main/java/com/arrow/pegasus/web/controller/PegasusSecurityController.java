...
@RestController
@RequestMapping("/api/pegasus/security")
public class PegasusSecurityController extends WebApiAbstract {
	...
	public UserModel user() {
		Product product = getCoreCacheHelper()
		        .populateProduct(getCoreCacheService().findProductBySystemName(ProductSystemNames.PEGASUS));
