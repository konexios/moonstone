...
import com.arrow.acn.client.api.GatewayApi;
...
import com.arrow.selene.SeleneCoreVersion;
import com.arrow.selene.SeleneEventNames;
import com.arrow.selene.SeleneEventNames.DeviceLoadParams;
...
import com.arrow.selene.engine.ShutdownListener;
...
import com.arrow.selene.engine.service.SshTunnelService;
...
public class SelfModule extends DeviceModuleAbstract<SelfInfo, SelfProperties, SelfStates, SelfData> {
	...
	public void stop() {
		String method = "stop";
		com.arrow.acn.client.utils.Utils.shutdownThread(registrationThread);
			...
			while (true) {
				try {
					...
					if (isShuttingDown()) {
						...
						com.arrow.acn.client.utils.Utils.sleep(EngineConstants.DEFAULT_GATEWAY_CHECK_IN_RETRY_MS);
					}
				}
			}
...
//            }
		...
		case SeleneEventNames.GATEWAY_STOP: {
			...
			com.arrow.acn.client.utils.Utils.sleep(5);
			System.exit(0);
			break;
		}
		default: {
