...
import com.arrow.selene.engine.EngineConstants.Variable;
...
import com.arrow.selene.engine.service.TelemetryService;
...
public abstract class DeviceModuleAbstract<Info extends DeviceInfo, Prop extends DeviceProperties, States extends DeviceStates, Data extends DeviceData>
	...
	public void stop() {
		...
		persistUpdatedDeviceInfo();
		super.stop();
		com.arrow.acn.client.utils.Utils.shutdownThread(localThread);
	}
