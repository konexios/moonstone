...
public class DoubleCubeSensorData extends SensorDataAbstract<double[]> {

	private final String format;

	public DoubleCubeSensorData(String name, double[] data, String format) {
		super(name, data);
		this.format = format;
	...
	public void writeIoTParameters(IotParameters parameters) {
		if (getData() != null) {
			parameters.setDoubleCube(getName(), getData()[0], getData()[1], getData()[2], format);
		}
	}
